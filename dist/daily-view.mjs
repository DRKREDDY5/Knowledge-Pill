 ...
 const refs=(ids,kind)=>{
  ...
  for(const id of ids){const s=sources.get(id);if(!s)throw Error('A citation does not match the sources.');
   ...
   if(kind==='news'){
    ...
    if(s.published_at===null||age<0||age>14*86400000)throw Error('News is future-dated or outside the fourteen-day edition window.');
